...
$(document).ready(function(){$(".table-result a.area").click(function(t){t.preventDefault();var a=$(this).closest("tr"),e=a.data("tr"),r=".table-result tbody.tr-group[data-tr="+e+"]";$(r).toggle()})});